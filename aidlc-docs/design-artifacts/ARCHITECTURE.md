...
> Ver [ADR-002](./ADR/ADR-002-react-shadcn-migration.md) para el porqué de esta arquitectura (reemplaza la vanilla original documentada en [ADR-001](./ADR/ADR-001-vendored-dependencies.md)).
